...
orders.total_products, orders.total_price,orders.idx,orders.invoice_no, orders.method,orders.payment_Status, orders.placed_on FROM users INNER JOIN orders ON users.id =
...
?>
        ...
        <div class="bill_ship">
            <div class="bill-to">
                ...
                <?php
            if ($OrdersMethod === 'Khalti' || $OrdersMethod === 'Esewa') {
                echo "<p><strong>Method:</strong> <span class='paymentstatus success' >$OrdersMethod</span></p>";
            } 
            elseif ($OrdersMethod === 'cash-on-delivery') {
                echo "<p><strong>Method:</strong> <span class='paymentstatus danger' >$OrdersMethod</span></p>";
            }
            else {
                echo "<p><strong>Method:</strong> <span class='paymentstatus danger' >$OrdersMethod</span></p>";
            }
            ...
            if ($Orderpayment_Status === 'Success') {
                echo "<p><strong>Status:</strong> <span class='paymentstatus success' >$Orderpayment_Status</span></p>";
            } else {
