    ...
    <section class="content">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
        $select_orders = $conn->prepare("SELECT orders.id,users.name,users.phone,users.address,users.city,users.state,orders.placed_on,orders.invoice_no,
        orders.total_products,orders.total_price,
        orders.order_status,orders.method FROM orders INNER JOIN users ON orders.user_id=users.id WHERE orders.order_status='Pending' ORDER BY orders.id ASC");
        ...
        $i=1;
         while($fetch_orders = $select_orders->fetch(PDO::FETCH_ASSOC)){
            ...
            $table.="<td><a onclick=\" return shipped($id)\" class='btn btn-badge badge-warning' href='javascript:void(0)'>&nbsp;&nbsp;Ship&nbsp;&nbsp;</a></td>"; 
            $table.="</tr>";
            $table.="</tbody>";
         }
            echo $table;
