                ...
                <div class="card-body p-0">
                    <div class="mailbox-controls">
                        ...
                        if ($fetch_admin['admin_status'] === 'super') {
                            $select_messages = $conn->prepare("SELECT users.name, users.email, messages.id, messages.user_message, messages.msg_pic, messages.date_Time FROM messages INNER JOIN users ON messages.user_id=users.id ORDER BY messages.id ASC");
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width:150px;" class="mailbox-name"><a
                                            href="read.php?inbox=<?=$fetch_message['id'];?>"><?= $fetch_message['name']; ?></a>
                                    </td>
                                    <?php
                                    ...
                                    <td style="width:500px; " class="mailbox-subject "><a style=" color: black; "
                                            href=" read.php?inbox=<?=$fetch_message['id'];?>">
                                            <b><?= $fetch_message['email']; ?></b> -
                                            <?= limitWords($fetch_message['user_message'], 8); ?></a>
                                    </td>
                                    <?php 
                                        if($fetch_message['msg_pic'] !== ''){
                                    echo'       
