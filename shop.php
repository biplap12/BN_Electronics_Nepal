...
<body>
   ...
   ?>
            <form action="" method="post" class="box">
                ...
                <div class="flex">
                    <div class="price" style="color: var( --orangeDark);">
                        <del style="text-decoration:line-through;color:red "><span style="color:var( --orange)">Rs
                                <?=$fetch_product['old_price'];?></span></del>
                        &nbsp;
                        <span>Rs </span><?= $fetch_product['price']; ?><span>/-</span>


                    </div> <input type="number" name="qty" class="qty" min="1" max="<?=$fetch_product['P_quantity']?>"
