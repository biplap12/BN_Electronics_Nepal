...
INSERT INTO `orders` (`id`, `user_id`, `method`, `order_status`, `payment_Status`, `invoice_no`, `idx`, `token`, `total_products`, `total_price`, `placed_on`, `cpl_o_inserter`, `shipped_order_inserter`) VALUES
(1, 15, 'Khalti', 'Completed', 'Success', '151705430563', 'TNvpUku32dB7AShcBSkWA3', 'qs22UPE5gY2t8N7ZNMjqJP', 'laptop (1000 x 1)', '1000', '2024-01-17 00:27:43', 1, 1),
(2, 15, 'Khalti', 'Completed', 'Success', '151705643504', 'aUuGx3xZtyhWXpHwaXiTH4', 'YeGRTdDjh8B269MBvursWE', 'laptop (1000 x 1)', '1000', '2024-01-19 11:36:44', 1, 1),
(3, 15, 'cash-on-delivery', 'Completed', 'Success', '151705643727', '', '', 'fridge (400 x 1)', '450', '2024-01-19 11:40:27', 1, 1),
(4, 15, 'Khalti', 'Pending', 'Success', '151705859547', 'PVRk5sJSJLDZXL7o4zYq25', 'HbqSAFbwWWQrNhz92bbe4B', 'fridge (400 x 1)', '400', '2024-01-21 23:37:27', NULL, NULL),
(5, 15, 'Esewa', 'Pending', 'Success', '151705859625', '0006PFU', '', 'Mobile (100 x 1)', '100', '2024-01-21 23:38:45', NULL, NULL),
(6, 15, 'cash-on-delivery', 'Cancelled', 'Cancelled', '151705859686', '', '', 'laptop (1000 x 1)', '1050', '2024-01-21 23:39:46', NULL, NULL),
(7, 15, 'Khalti', 'Pending', 'Success', '151705891747', 'gHCD4dN22JG84nD57v6cUQ', 'SmDD9oG5uAKYsJ8YQnSXCk', 'fridge (400 x 1)', '400', '2024-01-22 08:34:07', NULL, NULL),
(8, 15, 'cash-on-delivery', 'Pending', 'Pending', '151705913563', '', '', 'camera (500 x 1)', '550', '2024-01-22 14:37:43', NULL, NULL);
...
INSERT INTO `orders_items` (`id`, `user_id`, `pid`, `oid`, `order_qty`) VALUES
(1, 15, 3, 1, '1'),
(2, 15, 3, 2, '1'),
(3, 15, 2, 3, '1'),
(4, 15, 2, 4, '1'),
...
(2, 2, 2, 'fridge', '25 cu. ft. capacity, energy-efficient, stainless steel finish, adjustable shelves, ice maker, water dispenser, digital temperature control, LED lighting, smart connectivity.', 400, 500, 'fridge1.jpg', 'fridge2.jpg', 'fridge3.jpg', 97),
(3, 2, 3, 'laptop', '14-inch display, Intel Core i7 processor, 16GB RAM, 512GB SSD, dedicated graphics, backlit keyboard, Windows 10, HD webcam, USB-C, long-lasting battery.', 1000, 1500, 'laptop1.jpg', 'laptop2.jpg', 'laptop3.jpg', 98),
(4, 1, 4, 'Mobile', 'Mobile phones are handheld electronic devices for wireless communication, offering features like calls, texts, internet access, apps, and multimedia capabilities.', 100, 600, 'mobile1.jpg', 'mobile2.jpg', 'mobile3.jpg', 99);
...
--
-- Dumping data for table `sent_msg`
--

INSERT INTO `sent_msg` (`id`, `user_id`, `admin_id`, `Subject`, `admin_reply`, `admin_attch`, `date_Time`) VALUES
(1, 15, 1, 'test', 'sambid don ho', '', '2024-01-17 10:09:44');
...
(15, 'biplap', 'aaagamming111@gmail.com', '98000089005', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Bagmati State', 'Kathmandu ', 'nayabazar', 1, '0-02-03-8712d92d81c091db2750a4eb337ddd0356931e298a2efd37d0379ce2391eb189_5ba465f217b7f9a9.jpg', NULL, NULL, '0'),
...
(17, 'abc', 'aaa', '980000000000000', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'Bagmati State', 'kathmandu', 'nayabazar', 0, '', 1, NULL, ''),
